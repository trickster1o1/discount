...
@section('content')
    <div class="page-header">
        ...
        @if (authorize($menucode, 'CREATE', false))
            <a href="{{ route('vendors.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a>
        @endif
    </div>
    ...
    <div class="row">
        ...
        <div class="col-12 grid-margin stretch-card table-responsive">
            <table class="table bg-white list-data" id="list-data" data-url="{{ url('vendor_data') }}">
                <thead class="thead bg-primary text-white font-weight-bold">
                    <tr>
                        ...
                        <th scope="col" width="30%" data-column="vendor_name" data-filter="1">Name</th>
                        <th scope="col" data-column="email" data-filter="1">Email </th>
                        <th scope="col" width="1%" data-column="number" data-filter="1">Number</th>
