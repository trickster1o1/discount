...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-12 grid-margin stretch-card table-responsive">
            <table class="table bg-white list-data" id="list-data" data-url="{{ url('review_data') }}">
                <thead class="thead bg-primary text-white font-weight-bold">
                    <tr>
                        ...
                        <th scope="col" width="30%" data-column="title" data-filter="1">Name</th>
                        <th scope="col" width="30%" data-column="price" data-filter="1">Review</th>
                        <th scope="col" width="30%" data-column="price" data-filter="1">Rating</th>
