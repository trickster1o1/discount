...
@section('content')
    <div class="page-header">
        ...
        @if (authorize($menucode, 'CREATE', false))
            <a href="{{ route('discount.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a>
        @endif
    </div>
    ...
    <div class="row">
        ...
        <div class="col-12 grid-margin stretch-card table-responsive">
            <table class="table bg-white list-data" id="list-data" data-url="{{ url('discount_data') }}">
                <thead class="thead bg-primary text-white font-weight-bold">
                    <tr>
                        ...
                        <th scope="col" width="30%" data-column="product_title" data-filter="1">Title</th>
                        <th scope="col" width="30%" data-column="price" data-filter="1">Price</th>
                        <th scope="col" width="30%" data-column="value" data-filter="1">Discount</th>
